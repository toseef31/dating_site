<li id="conversation-{!! $conv->id !!}" data-id="{!! $conv->id !!}" class="conversation-item{!! ( Illuminate\Support\Facades\Route::is('message') && request()->id ==  $conv->id) || (!request()->id && $key == 0) ? ' active':''!!}" onclick="functionHide()" {
