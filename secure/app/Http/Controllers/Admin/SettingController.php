        ...
        if($validator->fails()){
            ...
            if($this->request->hasFile('logo')){
                ...
                if(in_array($logo->getClientOriginalExtension(),['jpg','png','gif','jpeg'])){
                    $upload = $logo->storeAs($this->base_path.'/uploads/sites',Str::random(20));
                    Setting::where('meta','website_logo')->update(['value'=>$upload['file']]);
            ...
            if($this->request->hasFile('logo_second')){
                ...
                if(in_array($logo->getClientOriginalExtension(),['jpg','png','gif','jpeg'])){
                    $upload = $logo->storeAs($this->base_path.'/uploads/sites',Str::random(20));
                    Setting::where('meta','logo_second')->update(['value'=>$upload['file']]);
                    if($old_logo && file_exists($this->base_path.'/'.$old_logo)){
                        unlink($this->base_path.'/'.$old_logo);
                    }
                }
            ...
            if($this->request->hasFile('register_background')){
                ...
                if(in_array($logo->getClientOriginalExtension(),['jpg','png','gif','jpeg'])){
                    $upload = $logo->storeAs($this->base_path.'/uploads/sites',Str::random(20));
                    Setting::where('meta','register_background')->update(['value'=>$upload['file']]);
                    if($old_logo && file_exists($this->base_path.'/'.$old_logo)){
                        unlink($this->base_path.'/'.$old_logo);
                    }
                }
            ...
            if($this->request->hasFile('home_background')){
                ...
                if($logo->acceptFile(['jpg','png','gif','jpeg'])){
                    $upload = $logo->storeAs($this->base_path.'/uploads/sites',Str::random(20));
                    Setting::where('meta','home_background')->update(['value'=>$upload['file']]);
                    if($old_logo && file_exists($this->base_path.'/'.$old_logo)){
                        unlink($this->base_path.'/'.$old_logo);
                    }
                }
            ...
            if($this->request->hasFile('social_image')){
                ...
                if(in_array($logo->getClientOriginalExtension(),['jpg','png','gif','jpeg'])){
                    $upload = $logo->storeAs($this->base_path.'/uploads/sites',Str::random(20));
                    Setting::where('meta','social_image')->update(['value'=>$upload['file']]);
                    if($old_logo && file_exists($this->base_path.'/'.$old_logo)){
                        unlink($this->base_path.'/'.$old_logo);
                    }
                }
